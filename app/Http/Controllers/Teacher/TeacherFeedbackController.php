...
class TeacherFeedbackController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('teacher.feedback.feedbacks', ['feedbacks'=> $feedbacks]);
    }
    ...
    public function create()
    {
        ...
        return view('teacher.feedback.add_feedback', ['feedback_types'=> $feedback_types]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('th_feedback.index');
    }
    ...
    public function edit($id)
    {
        ...
        $feedback_types = FeedbackType::all();
        return view('teacher.feedback.edit_feedback', ['feedback'=> $feedback, 'feedback_types'=> $feedback_types]);
    }
