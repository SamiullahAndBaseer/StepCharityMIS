                            ...
                            <div class="table_record">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="badge badge-light-primary text-start me-2 action-edit" href="{{ route('maktob.edit', $maktob->id) }}"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-3"><path d="M12 20h9"></path><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"></path></svg></a>
                                            <a class="delete_maktob badge badge-light-danger text-start confirm-{{ $maktob->id }}" href="#" data-id="{{ $maktob->id }}"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-trash"><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path></svg></a>
                                        </td>
                                    </tr>
                                    @endforeach
...
@section('custom_js_content')
    ...
    <script>
        $(document).on('mouseenter', '.delete_maktob', function(e){
            e.preventDefault();
            var id = $(this).data('id');
    ...
    @if(Session::has('maktob'))
    <script>
        Toast.fire({
            icon: 'success',
            title: '{{ Session::get('maktob') }}'
        });
    </script>
    @endif
    <script>
