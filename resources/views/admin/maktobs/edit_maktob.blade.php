            ...
            <div class="page-meta">
                <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Edit Maktob</li>
                    </ol>
                </nav>
            </div>
            <!-- /BREADCRUMB -->
                        ...
                        <div class="tab-pane fade show active" id="animated-underline-home" role="tabpanel" aria-labelledby="animated-underline-home-tab">
                            <div class="row">
                                <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
                                    <form class="section general-info"  method="post" action="{{ route('update.maktob', $maktob->id) }}"  enctype="multipart/form-data">
                                        @csrf
                                        <div class="info">
                                                            ...
                                                            <div class="row mx-auto">
                                                                <div class="col-xl-6 col-sm-12 mt-3 mb-3">
                                                                    <div class="form-group mt-3 mb-3">
                                                                        ...
                                                                        <input type="text" class="form-control mb-3" placeholder="Maktob title" value="{{ $maktob->title }}" name="title">
                                                                            ...
                                                                            <ul class="splide__list">
                                                                                ...
                                                                                @foreach ($images as $image)
                                                                                    ...
                                                                                    <li class="splide__slide">
                                                                                        <a href="{{ asset('files/maktobs') }}/{{ $image }}" class="glightbox">
                                                                                            <img alt="{{ $maktob->title }}" src="{{ asset('files/maktobs') }}/{{ $image }}">
                                                                                        </a>
                                                                                    </li>
                                                                                    @endif
                                                                                @endforeach
                                                                    ...
                                                                    <div id="thumbnail-slider" class="splide">
                                                                        <div class="splide__track">
                                                                            <ul class="splide__list">
                                                                                @foreach ($images as $image)
                                                                                    @if($image)
                                                                                    <li class="splide__slide"><img alt="{{ $maktob->title }}" src="{{ asset('files/maktobs') }}/{{ $image }}"></li>
                                                                                    @endif
                                                                                @endforeach
                                                                            </ul>
                                                                        </div>
                                                                ...
                                                                <div class="col-xl-6 col-sm-12 mt-3 mb-3">
                                                                    <div class="mt-3">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <select class="form-select mb-3" name="status">
                                                                                <option value="{{ $maktob->status }}">{{ $maktob->status }}</option>
                                                                    ...
                                                                    <div class="mt-3">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control mb-3" id="reference_to" placeholder="Reference to" value="{{ $maktob->reference_to }}" name="reference_to"  >
                                                                    ...
                                                                    <div class="mt-3">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <select class="form-select mb-3" id="maktob_type_id" name="maktob_type_id">
                                                                                <option value="{{ $maktob->maktobType->id }}">{{ $maktob->maktobType->name }}</option>
                                                                    ...
                                                                    <div class="mt-3 mb-3">
                                                                        <label for="filepond">New Images</label>
                                                                ...
                                                                <div class="col-md-12 mt-1">
                                                                    <div class="form-group text-end">
                                                                        <button type="submit" class="btn btn-secondary">Update Maktob</button>
                                                                    </div>
                                                                </div>
                                                            </div>
