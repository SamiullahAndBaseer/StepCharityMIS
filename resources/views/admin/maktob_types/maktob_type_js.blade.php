...
<script>
    $(document).ready(function(){
        // add new Maktob_type
        $(document).on('click', '.add_maktobType', function(e){
            e.preventDefault();
            let name = $('#name').val();
        ...
        // show MaktobType value in update form
        $(document).on('click', '#updateMaktobType', function(e){
            e.preventDefault();
            var id = $(this).data('id');
        ...
        // update course data
        $(document).on('click', '.update_maktobType', function(e){
            e.preventDefault();
            let up_id = $('#up_id').val();
        ...
        $(document).on('click', '#updateMaktobType', function(){
            $('.errName').text("");
            $('.errDescription').text("");
        });

        $(document).on('click', '#addMaktobType', function(){
            $('.errMsgName').text("");
            $('.errMsgDescription').text("");
        });

        // delete maktob type
        $(document).on('mouseenter', '.delete_maktobType', function(e){
            e.preventDefault();
