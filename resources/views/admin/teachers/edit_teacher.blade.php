                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="email" class="form-control mb-3" value="{{ $teacher->email }}" id="email" placeholder="hello@example.com" name="email">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control mb-3" value="{{ $teacher->phone_number }}" id="phone" placeholder="00937xxxxxxxxx" name="phone_number" >
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control mb-3" value="{{ $teacher->id_card_number }}" id="id_card_number" placeholder="tazkira number here" name="id_card_number" >
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control mb-3" value="{{ $teacher->salary }}" id="salary" name="salary" placeholder="salary per day" >
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control flatpickr flatpickr-input active mb-3" id="basicFlatpickr" placeholder="yyyy-mm-dd" value="{{ $teacher->date_of_birth }}" name="date_of_birth"/>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control flatpickr-input active mb-3" id="joinDate" placeholder="yyyy-mm-dd" value="{{ $teacher->join_date }}" name="join_date"/>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control mb-3" value="{{ $teacher->address }}" name="address" placeholder="Address"  >
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <select class="form-select mb-3 dynamic" id="province" name="province">
                                                                                @if($teacher->district != null)
                                                                                    <option value="{{ $teacher->district->province->id }}">{{ $teacher->district->province->name }}</option>
                                                                                @endif
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <select class="form-select mb-3" id="district" name="district">
                                                                                @if($teacher->district_id != null)
                                                                                    <option value="{{ $teacher->district_id }}">{{ $teacher->district->name }}</option>
                                                                                @endif
