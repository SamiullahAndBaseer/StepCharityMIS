                        ...
                        <div class="tab-pane fade show active" id="animated-underline-home" role="tabpanel" aria-labelledby="animated-underline-home-tab">
                            <div class="row">
                                <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
                                    <form class="section general-info" method="POST" action="{{ route('update.contract', $contract->id) }}"  enctype="multipart/form-data">
                                        @csrf
                                        <div class="info">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-xl-5 offset-xl-1 col-sm-12 mt-3">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select class="form-select mb-3" name="contract_type">
                                                                            <option value="{{ $contract->contract_type_id }}">{{ $contract->contract_type->name }}</option>
                                                                ...
                                                                <div class="col-xl-6 col-sm-12 col-6 mt-3">
                                                                    <div class="col-xl-6 col-sm-12">
                                                                        ...
                                                                        <select id="user_id" name="user_id">
                                                                            <option value="{{ $contract->user->id }}" selected>{{ $contract->user->first_name }}&nbsp;{{ $contract->user->last_name }}</option>
                                                                ...
                                                                <div class="col-xl-5 offset-xl-1 col-sm-12 mt-3">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input id="start_date" name="start_date" value="{{ $contract->start_date }}" class="form-control flatpickr flatpickr-input active" type="text" placeholder="Select Date..">
                                                                ...
                                                                <div class="col-xl-5 col-sm-12 mt-3">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input id="end_date" name="end_date" value="{{ $contract->end_date }}" class="form-control flatpickr flatpickr-input active" type="text" placeholder="Select Date..">
