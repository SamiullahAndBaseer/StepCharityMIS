                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-8 col-lg-8 col-md-10 offset-lg-2 offset-md-1">
                                <div class="alert alert-light-success alert-dismissible fade show border-0 mb-4" role="alert">
                                    ...
                                    <strong>Success</strong> {{ session()->get('feedback_added') }}</button>
                                </div>
                            </div>
                            @endif
                            <div id="ft" class="col-xl-8 col-lg-8 col-md-10 offset-lg-2 offset-md-1 layout-spacing pt-5">
                                <form class="section general-info" method="post" action="{{ route('feedback.store') }}">
                                    @csrf
