...
<script>
    $(document).ready(function(){
        $(document).on('mouseenter', '.delete_guarantee', function(e){
            e.preventDefault();
            var id = $(this).data('id');
...
<script>
    var guaranteeList = $('#guarantee-table').DataTable({
        ...
        buttons: [
            {
                ...
                action: function(e, dt, node, config ) {
                    window.location = '{{ route('survey.index') }}';
                }
            }
        ],
        "order": [[ 1, "asc" ]],
