            ...
            <div class="page-meta">
                <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">User Guarantee Edit Form</li>
                    </ol>
                </nav>
            </div>
            <!-- /BREADCRUMB -->
                        ...
                        <div class="tab-pane fade show active" id="animated-underline-home" role="tabpanel" aria-labelledby="animated-underline-home-tab">
                            <div class="row">
                                <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
                                    <form class="section general-info"  method="post" action="{{ route('update.guarantee') }}"  enctype="multipart/form-data">
                                        @csrf
                                        <div class="info">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xl-10 col-lg-12 col-md-8 mt-md-0 mt-4">
                                                            <div class="form">
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <input type="hidden" name="id" value="{{ $user_guarantee->id }}">
                                                                        <input type="hidden" name="survey_id" value="{{ $user_guarantee->survey_id }}">
                                                                        <div class="form-group">
                                                                            <label for="first_name">First Name<span class="text-danger">*</span></label>
                                                                            <input type="text" class="form-control mb-3" id="first_name" placeholder="First Name" value="{{ $user_guarantee->first_name }}" name="first_name"  >
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control mb-3" id="last_name" placeholder="Last Name" value="{{ $user_guarantee->last_name }}" name="last_name" >
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control mb-3" id="father_name" placeholder="Father Name" value="{{ $user_guarantee->father_name }}" name="father_name" >
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="email" class="form-control mb-3" id="email" placeholder="name@example.com" value="{{ $user_guarantee->email }}" name="email">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control mb-3" id="phone_number" placeholder="+937xxxxxxxx" value="{{ $user_guarantee->phone_number }}" name="phone_number" >
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control mb-3" id="whatsapp" placeholder="+937xxxxxxxx" value="{{ $user_guarantee->whatsapp }}" name="whatsapp" >
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control mb-3" id="id_card_number" placeholder="1401-xxxx-xxxx" value="{{ $user_guarantee->id_card_number }}" name="id_card_number" >
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <select class="form-control" name="relation">
                                                                                <option value="{{ $user_guarantee->relation }}">{{ $user_guarantee->relation }}</option>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control flatpickr flatpickr-input active mb-3" id="dateOfBirth" placeholder="yyyy-mm-dd" value="{{ $user_guarantee->DoB }}" name="date_of_birth"/>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="original_address" class="form-control mb-3" id="original_address" value="{{ $user_guarantee->original_address }}" name="original_address" placeholder="Original Address" >
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="current_address" class="form-control mb-3" id="current_address" value="{{ $user_guarantee->current_address }}" name="current_address" placeholder="Current Address" >
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control mb-3" id="description" value="{{ $user_guarantee->description }}" name="description" placeholder="answer here">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="form-check mt-2 form-check-primary form-check-inline">
                                                                                <input class="form-check-input" type="radio" name="gender" value="1" id="form-check-radio-primary" @if($user_guarantee->gender == 1) checked @endif>
                                                                            ...
                                                                            <div class="form-check mt-2 form-check-info form-check-inline">
                                                                                <input class="form-check-input" type="radio" name="gender" value="0" id="form-check-radio-info" @if($user_guarantee->gender == 0) checked @endif>
                                                                    ...
                                                                    <div class="col-md-12 mt-1">
                                                                        <div class="form-group text-end">
                                                                            <button type="submit" class="btn btn-secondary">Update</button></button>
                                                                        </div>
                                                                    </div>
                                                                </div>
...
<script>
    ...
    <script>
                ...
                files: [
                    {
                        ...
                        source: '{{ asset('images/user_guarantees') }}/{{ $user_guarantee->photo }}',
        ...
        FilePond.setOptions({
            server: {
                url: '{{ route('update.guarantee.image', $user_guarantee->id) }}',
                headers: {
