            ...
            <div class="page-meta">
                <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Edit Survey Form</li>
                    </ol>
                </nav>
            </div>
            <!-- /BREADCRUMB -->
                        ...
                        <div class="tab-pane fade show active" id="animated-underline-home" role="tabpanel" aria-labelledby="animated-underline-home-tab">
                            <div class="row">
                                <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
                                    <form class="section general-info"  method="post" action="{{ route('update.survey', $survey->id) }}"  enctype="multipart/form-data">
                                        @csrf
                                        <div class="info">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control mb-3" id="first_name" value="{{ $survey->first_name }}" name="first_name"  >
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control mb-3" id="last_name" value="{{ $survey->last_name }}" name="last_name" >
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control mb-3" id="father_name" value="{{ $survey->father_name }}" name="father_name" >
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="email" class="form-control mb-3" id="email" placeholder="Write your email here" value="{{ $survey->email }}" name="email">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control mb-3" id="primary_phone_number" value="{{ $survey->primary_phone_number }}" name="primary_phone_number" >
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control mb-3" id="whatsapp_number" placeholder="+937xx" value="{{ $survey->whatsapp_number }}" name="whatsapp_number" >
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control mb-3" id="id_card_number" value="{{ $survey->id_card_number }}" name="id_card_number" >
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <select class="form-select mb-3" id="course_id" name="course_id">
                                                                                <option value="{{ $survey->course_id }}">{{ $survey->course->name }}</option>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control flatpickr flatpickr-input active mb-3" id="dateOfBirth" value="{{ $survey->date_of_birth }}" name="date_of_birth"/>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control mb-3" value="{{ $survey->mosque_name }}" name="mosque_name" placeholder="Mosque name"') }}" >
                                                                            @error('mosque_name')
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="original_location" class="form-control mb-3" id="original_location" value="{{ $survey->original_location }}" name="original_location" placeholder="Original Location" >
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="current_location" class="form-control mb-3" id="current_location" value="{{ $survey->current_location }}" name="current_location" placeholder="Current Location" >
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="question_one" class="form-control mb-3" id="question_one" value="{{ $survey->question_one }}" name="question_one" placeholder="Question one" >
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="question_two" class="form-control mb-3" id="question_two" value="{{ $survey->question_two }}" name="question_two" placeholder="Question Two" >
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="question_three" class="form-control mb-3" id="question_three" value="{{ $survey->question_three }}" name="question_three" placeholder="Question Three" >
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="question_four" class="form-control mb-3" id="question_four" value="{{ $survey->question_four }}" name="question_four" placeholder="Question Four" >
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="form-group col-sm-6 col-xl-6 col-md-6 col-6">
                                                                                ...
                                                                                <div class="form-check mt-2 form-check-primary form-check-inline">
                                                                                    <input class="form-check-input" type="radio" name="gender" value="1" id="form-check-radio-primary" @if($survey->gender == 1) checked @endif>
                                                                                ...
                                                                                <div class="form-check mt-2 form-check-info form-check-inline">
                                                                                    <input class="form-check-input" type="radio" name="gender" value="0" id="form-check-radio-info" @if($survey->gender == 0) checked @endif>
                                                                            ...
                                                                            <div class="form-group col-sm-6 col-xl-6 col-md-6 col-6">
                                                                                ...
                                                                                <div class="form-check mt-2 form-check-primary form-check-inline">
                                                                                    <input class="form-check-input" type="radio" name="marital_status" value="married" id="form-check-radio-primary" @if($survey->marital_status == 'married') checked @endif>
                                                                                    <label class="form-check-label" for="form-check-radio-primary">
                                                                                        Marriade
                                                                                    </label>
                                                                                </div>
                                                                                ...
                                                                                <div class="form-check mt-2 form-check-info form-check-inline">
                                                                                    <input class="form-check-input" type="radio" name="marital_status" value="single" id="form-check-radio-info" @if($survey->marital_status == 'single') checked @endif>
                                                                                    <label class="form-check-label" for="form-check-radio-info">
                                                                                        Single
                                                                                    </label>
                                                                                </div><br/>
...
<script>
    ...
    <script>
                ...
                files: [
                    {
                        ...
                        source: '{{ asset('images/surveys') }}/{{ $survey->photo }}',
        ...
        FilePond.setOptions({
            server: {
                url: '{{ route('update.survey.image', $survey->id) }}',
                headers: {
