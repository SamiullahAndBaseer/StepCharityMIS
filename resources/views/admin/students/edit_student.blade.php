                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="form-check form-check-primary form-check-inline">
                                                                                <input class="form-check-input" type="radio" name="marital_status" value="1" id="form-check-radio-primary" @if($student->status == 1) checked @endif>
                                                                                <label class="form-check-label" for="form-check-radio-primary">
                                                                                    Marriade
                                                                                </label>
                                                                            </div>
                                                                            ...
                                                                            <div class="form-check form-check-info form-check-inline">
                                                                                <input class="form-check-input" type="radio" name="marital_status" value="0" id="form-check-radio-info" @if($student->status == 0) checked @endif>
                                                                                <label class="form-check-label" for="form-check-radio-info">
                                                                                    Single
                                                                                </label>
                                                                            </div><br/>
...
<script>
    ...
    <script>
        ...
        FilePond.setOptions({
            server: {
                url: '{{ route('update.image', $student->id) }}',
                headers: {
