                        ...
                        <table id="invoice-list" class="table dt-table-hover" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="./app-invoice-preview.html"><span class="inv-number">#{{ $student->id }}</span></a></td>
                                    <td>
                                        <div class="d-flex">
                                            <div class="usr-img-frame me-2 rounded-circle">
                                                <img alt="avatar" class="img-fluid rounded-circle" src="{{ asset('storage')}}/{{ $student->profile_photo_path }}">
                                            </div>
                                    ...
                                    <td>
                                        <a class="badge badge-light-primary text-start me-2 action-edit" href="/user/{{$student->id}}"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-3"><path d="M12 20h9"></path><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"></path></svg></a>
