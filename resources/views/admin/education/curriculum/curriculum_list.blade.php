            ...
            <div class="row " id="cancel-row">
                ...
                <div class="col-xl-12 col-lg-12 col-sm-12 layout-top-spacing layout-spacing">
                    <div class="widget-content widget-content-area br-8">
                        <table id="curriculums-table" class="table dt-table-hover" style="width:100%">
                            <div class="table_record">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="#"><span class="inv-number">#{{ $curriculum->id }}</span></a></td>
                                        <td>
                                            <a href="#" class="d-flex">
                                                <p class="align-self-center mb-0 user-name"> {{ $curriculum->title }} </p>
                                            </a>
                                        </td>
                                        <td><span class="inv-amount">{{ $curriculum->course->name }}</span></td>
