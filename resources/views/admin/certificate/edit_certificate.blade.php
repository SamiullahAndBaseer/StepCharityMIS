                        ...
                        <div class="tab-pane fade show active" id="animated-underline-home" role="tabpanel" aria-labelledby="animated-underline-home-tab">
                            <div class="row">
                                <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
                                    <form class="section general-info" method="POST" action="{{ route('update.certificate', $certificate->id) }}"  enctype="multipart/form-data">
                                        @csrf
                                        <div class="info">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-xl-4 col-sm-12 mt-3">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select class="course_id form-control" name="course_id">
                                                                            <option value="{{ $certificate->course_id }}">{{ $certificate->course->name }}</option>
                                                                ...
                                                                <div class="col-xl-4 col-sm-12 col-6 mt-3">
                                                                    <div class="col-xl-6 col-sm-12">
                                                                        ...
                                                                        <select id="user_id" name="user_id">
                                                                            <option value="{{ $certificate->user->id }}" selected>{{ $certificate->user->first_name }}&nbsp;{{ $certificate->user->last_name }}</option>
                                                                ...
                                                                <div class="col-xl-10 offset-xl-1 col-sm-12 mt-3">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <textarea name="description" id="description" class="form-control" style="display: none;">{{ $certificate->description }}</textarea>
                                                                ...
                                                                <div class="col-xl-11 col-md-12 mt-3">
                                                                    <div class="form-group text-end">
                                                                        <button type="submit" class="btn btn-secondary">Update Certificate</button>
                                                                    </div>
                                                                </div>
                                                            </div>
