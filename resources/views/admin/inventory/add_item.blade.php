                    ...
                    <div id="basic" class="col-lg-12 layout-spacing mx-auto">
                        <div class="statbox widget box box-shadow">
                            ...
                            <div class="widget-content widget-content-area mx-auto">
                                <form method="POST" action="{{ route('inventory.store') }}" class="mx-auto">
                                    @csrf
                                    <div class="row mx-auto">
                                        ...
                                        <div class="col-xl-4 col-md-6 col-sm-12 mt-3">
                                            ...
                                            <input type="date" class="form-control flatpickr flatpickr-input active mb-3" name="date_purchase" id="date_purchase" placeholder="yyyy-mm-dd" />
                                            @error('date_purchase')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-xl-4 col-md-6 col-sm-12 mt-3">
                                            ...
                                            <input type="text" name="total_cost_lc" id="total_cost_lc" class="form-control">
                                            @error('total_cost_lc')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="col-xl-4 col-md-6 col-sm-12 mt-3">
                                            ...
                                            <input type="text" name="total_cost_usd" id="total_cost_usd" class="form-control">
                                        ...
                                        <div class="col-xl-4 col-md-6 col-sm-12 mt-3">
                                            ...
                                            <input type="text" name="age_in_year" id="age_in_year" class="form-control">
                                            @error('age_in_year')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="col-xl-4 col-md-6 col-sm-12 mt-3">
                                            ...
                                            <input type="text" name="useful_life" id="useful_life" class="form-control">
                                            @error('useful_life')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="col-xl-4 col-md-6 col-sm-12 mt-3">
                                            ...
                                            <input type="text" name="current_value_lc" id="current_value_lc" class="form-control">
                                        ...
                                        <div class="col-xl-4 col-md-6 col-sm-12 mt-3">
                                            ...
                                            <input type="text" name="current_value_usd" id="current_value_usd" class="form-control">
                                        ...
                                        <div class="col-12">
                                            <button type="submit" class="btn btn-primary mt-3 float-end">Add Item</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
