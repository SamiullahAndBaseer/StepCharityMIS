                        ...
                        <table id="invoice-list" class="table dt-table-hover" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="./app-invoice-preview.html"><span class="inv-number">#{{ $user->id }}</span></a></td>
                                    <td>
                                        <div class="d-flex">
                                            <div class="usr-img-frame me-2 rounded-circle">
                                                <img alt="avatar" class="img-fluid rounded-circle" src="{{ asset('storage/users')}}/{{ $user->profile_photo_path }}">
                                            </div>
