            ...
            <div class="page-meta">
                <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Employees Attendance</li>
                    </ol>
                </nav>
            </div>
            <!-- /BREADCRUMB -->
                        ...
                        <table id="invoice-list" class="table dt-table-hover" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('single.user', $attend->id) }}" class="d-flex">
                                            <div class="usr-img-frame me-2 rounded-circle">
                                                <img alt="avatar" class="img-fluid rounded-circle" src="{{ asset('images')}}/{{ $attend->profile_photo_path }}">
                                            </div>
                                            <p class="align-self-center mb-0 user-name"> {{ $attend->first_name }}&nbsp;{{ $attend->last_name }} </p>
                                        </a>
                                    </td>
                                    <td>
