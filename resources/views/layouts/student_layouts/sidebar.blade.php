...
<li class="menu {{ Request::is('class/*') || Request::is('single-user/*') || Request::is('class') ? 'active' : '' }}">
    ...
    <ul class="collapse submenu list-unstyled" id="class_attendance" data-bs-parent="#accordionExample">
        <li class="{{ Request::is('single-user/*') ? 'active' : '' }}">
            <a href="{{ route('single.user', Auth::user()->id) }}">Show Details</a>
        </li>
    </ul>
</li>
...
<li class="menu {{ Request::is('student_education') || Request::is('student-assignments') || Request::is('th_curriculum/*') || Request::is('th_curriculums') || Request::is('add/lesson') || Request::is('all/lessons') || Request::is('th-course/*') || Request::is('all_assignment') || Request::is('edit/assignment/*') ? 'active' : '' }}">
    ...
    <ul class="collapse submenu list-unstyled" id="education" data-bs-parent="#accordionExample">
        <li class="{{ Request::is('student_education') ? 'active' : '' }}">
            <a href="{{ route('student_education.index') }}"> Lessons List</a>
        </li>
        <li class="{{ Request::is('student-assignments') ? 'active' : '' }}">
            <a href="{{ route('st.assignments') }}"> Assginmnet List</a>
        </li>
    </ul>
</li>
...
<li class="menu {{ Request::is('st_feedback/create') || Request::is('st_feedback') || Request::is('st_feedback/*/edit') ? 'active' : '' }}">
    ...
    <ul class="collapse submenu list-unstyled" id="feedback" data-bs-parent="#accordionExample">
        <li class="{{ Request::is('st_feedback/create') ? 'active' : ''}}">
            <a href="{{ route('st_feedback.create') }}">Send Feedback </a>
        </li>
        <li class="{{ Request::is('st_feedback') || Request::is('st_feedback/*/edit') ? 'active' : ''}}">
            <a href="{{ route('st_feedback.index') }}">Feedback List</a>
        </li>
    </ul>
</li>
...
<li class="menu {{ Request::is('student_education/create') ? 'active' : '' }}">
    ...
    <ul class="collapse submenu list-unstyled" id="leave" data-bs-parent="#accordionExample">
        <li class="{{ Request::is('student_education/create') ? 'active' : '' }}">
            <a href="{{ route('student_education.create') }}"> Add Leave </a>
        </li>
    </ul>
</li>