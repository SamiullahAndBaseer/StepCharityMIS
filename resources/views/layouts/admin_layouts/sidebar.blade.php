<div class="sidebar-wrapper sidebar-theme">
    ...
    <nav id="sidebar">
        ...
        <div class="navbar-nav theme-brand flex-row  text-center">
            <div class="nav-logo">
                <div class="nav-item theme-logo">
                    <a href="/dashboard">
                        <img src="{{ asset('assets/src/assets/img/logo.png') }}" alt="logo">
                    </a>
                </div>
        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            ...
            <li class="menu">
                <a href="{{route('user.attendance')}}" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
            ...
            <li class="menu">
                <a target="_blank" href="{{ asset('assets/../documentation/index.html') }}" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
