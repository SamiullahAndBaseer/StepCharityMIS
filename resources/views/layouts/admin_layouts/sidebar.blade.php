    ...
    <nav id="sidebar">
        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            @auth
                ...
                <li class="menu {{ Request::is('th-course') || Request::is('st-course') || Request::is('curriculum/*') || Request::is('curriculum') || Request::is('lesson/*') || Request::is('lesson') || Request::is('th-course/create') || Request::is('all_assignment') ? 'active' : '' }}">
                    <a href="#education" data-bs-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                        <div class="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-users"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>
                            <span>Education</span>
                    ...
                    <ul class="collapse submenu list-unstyled" id="education" data-bs-parent="#accordionExample">
                        ...
                        <li class="{{ Request::is('all_assignment') ? 'active' : '' }}">
