            ...
            <div class="page-meta">
                <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Send Request For Item</li>
                    </ol>
                </nav>
            </div>
            <!-- /BREADCRUMB -->
                        ...
                        <div class="tab-pane fade show active" id="animated-underline-home" role="tabpanel" aria-labelledby="animated-underline-home-tab">
                            <div class="row">
                                <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
                                    <form class="section general-info"  method="post" action="{{ route('request-item.store') }}">
                                        @csrf
                                        <div class="info">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control mb-3" id="title" placeholder="Item title" value="{{ old('title') }}" name="title"  >
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <textarea name="description" rows="1" class="form-control mb-3" id="description" placeholder="description"></textarea>
