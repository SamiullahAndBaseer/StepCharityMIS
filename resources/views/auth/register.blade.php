    ...
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div>
                ...
                <x-jet-input id="father_name" class="block mt-1 w-full" type="text" name="father_name" :value="old('father_name')" autocomplete="father_name" />
            ...
            <div>
                <x-jet-label for="id_card_number" value="{{ __('Identy card Number') }}" />
                <x-jet-input id="id_card_number" class="block mt-1 w-full" type="text" name="id_card_number" :value="old('id_card_number')" required autofocus autocomplete="id_card_number" />
            </div>

            <div>
                <x-jet-label for="salary" value="{{ __('Salary') }}" />
                <x-jet-input id="salary" class="block mt-1 w-full" type="text" name="salary" :value="old('salary')" autofocus autocomplete="salary" />
            </div>
            ...
            <div>
                <x-jet-label for="role_id" value="{{ __('Role of User') }}" />
                <select class="block mt-1 w-full" id="role_id" name="role_id" :value="old('role_id')">
