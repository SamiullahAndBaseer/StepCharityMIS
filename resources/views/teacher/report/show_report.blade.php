                                                        ...
                                                        <div class="inv--head-section inv--detail-section">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-6 text-md">
                                                                    <h3 class="inv-list-number mt-sm-3 pb-sm-2 mt-2"><span class="inv-title"></span>Report of {{ $report->user->first_name }}&nbsp;{{ $report->user->last_name }}</h3>
                                                                    <p class="inv-created-date mt-sm-5 mt-3"><span class="inv-title">Report type : </span> <span class="inv-date">{{ $report->reportType->name }}</span></p>
                                                                    <p class="inv-created-date"><span class="inv-title">Title : </span> <span class="inv-date">{{ $report->title }}</span></p>
                                                                    <p class="inv-created-date"><span class="inv-title">Receiver : </span> <span class="inv-date">{{ $report->receiver }}</span></p>
                                                        ...
                                                        <div class="inv--note">
                                                            ...
                                                            <div class="row mt-4">
                                                                <div class="col-sm-12 col-12 order-sm-0 order-1">
                                                                    <p>Note: Go to print you can print it. <span class="text-info">sent at: {{ $report->created_at }}</span></p>
                                                                </div>
                                                            </div>
