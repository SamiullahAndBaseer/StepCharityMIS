                        ...
                        <div class="tab-pane fade show active" id="animated-underline-home" role="tabpanel" aria-labelledby="animated-underline-home-tab">
                            <div class="row">
                                <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
                                    <form class="section general-info"  method="post" action="{{ route('update.quotation') }}">
                                        @csrf
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control mb-3" id="name" placeholder="Item name" value="{{ $quotation->name }}" name="name"  >
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control mb-3" id="quality" placeholder="Item quality" value="{{ $quotation->quality }}" name="quality"  >
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control mb-3" id="price" placeholder="Item price" value="{{ $quotation->price }}" name="price"  >
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control mb-3" id="discount" placeholder="Item discount" value="{{ $quotation->discount }}" name="discount"  >
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <select class="form-select mb-3" id="proposal_id" name="proposal_id">
                                                                                <option value="{{ $quotation->proposal_id }}">{{ $quotation->proposalItem->title }}</option>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <select class="form-select mb-3" id="currency_id" name="currency_id">
                                                                                <option value="{{ $quotation->currency_id }}">{{ $quotation->currency->name }}</option>
                                                                    ...
                                                                    <div class="col-xl-6 col-sm-12 mt-1 mb-3">
                                                                        ...
                                                                        <div>
                                                                            <img width="300px" src="{{ asset('files/quotations') }}/{{ $quotation->bill_image }}" alt="{{ $quotation->bill_image }}">
                                                                        </div>
                                                                    </div>
