            ...
            <div class="page-meta">
                <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Employee Leaves</li>
                    </ol>
                </nav>
            </div>
            <!-- /BREADCRUMB -->
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($leaves as $leave)
                                            @if($leave->user->role->name === 'Employee')
                                            <tr>
                                                <td>
                                                </td>
                                                ...
                                                <td>
                                                    @if($leave->status == 'approved')
                                                        <div class="btn-group dropstart" role="group">
                                                            <span><span class="badge badge-light-info">Approved</span></span>
                                                        </div>
                                                    @elseif($leave->status == 'rejected')
                                                            <span><span class="badge badge-light-danger">Rejected</span></span>
                                                    @else
                                                        <div class="btn-group dropstart" role="group">
                                                            <span><span class="badge badge-light-success">Pending</span></span>
