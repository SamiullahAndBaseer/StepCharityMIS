            ...
            <div class="row " id="cancel-row">
                ...
                <div class="col-xl-12 col-lg-12 col-sm-12 layout-top-spacing layout-spacing">
                    <div class="widget-content widget-content-area br-8">
                        <table id="inventories-table" class="table dt-table-hover" style="width:100%">
                            <div class="table_record">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="#" class="d-flex">
                                                <p class="align-self-center mb-0 user-name"> {{ $inventory->tag_no }} </p>
                                            </a>
                                        </td>
                                        <td><span class="inv-amount">{{ $inventory->category->name }}</span></td>
                                        <td>{{ $inventory->office }}</td>
